<div id="popupStockEdit" class="overlay">
	<div class="popup">
		...
		<div class="popupContent">
            ...
            <h3>Username</h3>
            <div class="inputDiv"><input type="text" id="username" placeholder="User Name"></div>
            <h3>Name</h3>
            <div class="inputDiv"><input type="text" id="name" placeholder="Name"></div>
            <h3>Debt</h3>
            <div class="inputDiv"><input type="number" id="userBalance" placeholder="Debt"></div>
            
            <!-- Those fields are hidden for now -->
            <h3 class="lang" key="password" hidden>Password</h3>
            <div class="inputDiv" hidden><input type="password" id="userPassword" placeholder="Password"></div>
            <h3 class="lang" key="email" hidden>Email address</h3>
            <div class="inputDiv" hidden><input type="email" id="userEmail" placeholder="Email address"></div>
            <h3 class="lang" key="phone_number" hidden>Phone number</h3>
            <div class="inputDiv" hidden><input type="tel" id="userPhone" placeholder="Phone number"></div>
