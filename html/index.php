...
<body>
    <img src="../resources/img/logo.gif" alt="Jamaica Inn" style="height:45%;">
    <section class="container">
        <div class="login">
            <h1>Log in by filling in the fields below</h1>
            <form name="loginForm" method="post" action="consumer_main.php?filter=all&lang=en">
                <div>
                    <input class="field" type="text" name="username" value="" placeholder="Nickname">
                </div>
                <div>
