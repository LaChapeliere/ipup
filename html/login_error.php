    ...
    <div class="popup">
        <form>
            ...
            <div class="popupContent">
                ...
                <h3 id="errorMessage">Hello! Incorrect username or password has been entered. Please try again or contact an admin.</h3>
                <br>

                <h3>Message to Admin</h3>
                <div class="inputDiv">
                    <input type="text" id="messageText" placeholder="Hi, I have an issue...">
                </div>
